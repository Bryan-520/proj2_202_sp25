...
from proj2 import Row, Node, read_csv_lines, listlen, filter_rows
...
class TestStructureBasics(unittest.TestCase):
    ...
    def test_node_instantiation(self):
        ...
        n = Node(r, None)
        self.assertEqual(n.first.country, "USA")
        self.assertIsNone(n.rest)
    ...
    def test_node_chain(self):
        ...
        n2 = Node(r2, None)
        n1 = Node(r1, n2)
        self.assertEqual(n1.first.country, "A")
        self.assertEqual(n1.rest.first.country, "B")


class TestFunctionSignatures(unittest.TestCase):

    def test_read_csv_lines_returns_linked_list(self):
        result = read_csv_lines("sample.csv")  # will need a dummy file or you can mock
        self.assertTrue(result is None or isinstance(result, Node))

    def test_listlen_on_none(self):
        self.assertEqual(listlen(None), 0)

    def test_listlen_on_chain(self):
    ...
    def test_filter_rows_returns_linked_list_or_none(self):
